                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <select class="form-control col-md-3" v-model="criterio">
                              ...
                              <option value="num_documento">Num comprobante</option>
                             </select>
                            <input type="text" class="form-control" placeholder="Texto a buscar" v-model="buscar" 
                            @keyup.enter="listarVenta(1, criterio, buscar)">
                            <button type="button" @click="listarVenta(1, criterio, buscar)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                        ...
                        <tr v-for="venta in ArrayVenta" :key="venta.id_venta">
                            <td>
                                <button type="button" class="btn btn-success btn-sm" v-on:click="verVenta(venta.id_venta)" >
                                  <i class="icon-eye" ></i>
                                </button> &nbsp;

                                 <!-- //si la categoria.condicion es 1 -->
                                <template v-if="venta.estado=='Registrado'">
                                    <button type="button" class="btn btn-danger btn-sm" v-on:click="anularVenta(venta.id_venta)">
                            ...
                            <td v-text="venta.tipo_documento"></td>
            ...
            <div class="card-body">
                ...
                <div class="form-group row border">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <!-- btn agregar -->
                            <button class="btn btn-success form-control btnagregar" v-on:click="agregarDetalleV()">
                                <i  class="icon-plus"></i>
                            </button>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        computed:{
            ...
            calculartotal: function(){
               ...
               for (let index = 0; index < this.ArrayDetalle.length; index++) {
                   resultado = resultado + (this.ArrayDetalle[index].precio * this.ArrayDetalle[index].cantidad - this.ArrayDetalle[index].descuento);
        ...
        methods: {
            //listado + fintreos
            listarVenta(page, criterio, buscar){
                let atrapar = this;
                ...
                axios.get(url).then(function (json) {
                    ...
                    atrapar.ArrayVenta = respuesta.ventas.data;
            ...
            selectCliente(search,loading){
                ...
                var url ='/cliente/select?filtro=' + search;
                ...
                axios.get(url).then(function (json) {
                    ...
                    atrapar.arrayCliente = respuesta.clientes;
            ...
            getDatosCliente(vall){
                ...
                // for (let index = 0; index < me.arrayCliente.length; index++) {
                //      me.id_cliente = me.arrayCliente[index].id_persona;
                //      me.cliente = me.arrayCliente[index].nombre;
                // }

                console.log(vall.id_persona);

            },
            //el metodo de arriba no sirve, para ello se uso el @input y un metodo en especifico del vue select
            CaptureValor(val){
                let me = this;
                me.loading = true;
             
                me.id_cliente = val.id_persona; 
            ...
            buscarArticulo(){
                ...
                var url = '/articulo/buscarVenta?filtro=' + e.codigo;
                ...
                axios.get(url).then(function (json){
                    ...
                    if(e.arrayArticulo.length>0){
                        ...
                        e.precio = e.arrayArticulo[0]['precio_venta'];
                        e.stock = e.arrayArticulo[0]['stock'];
                        //e.stocka = 3;
                        //console.log(arrayArticulo[0]['stock']);
            ...
            cambiarPagina(page, criterio, buscar){
                ...
                me.listarVenta(page, criterio, buscar);
            },
            ...
            agregarDetalleV(){
                ...
                if(me.id_articulo==0 | me.cantidad==0 | me.precio==0){
                    ...
                    if(me.encuentra(me.id_articulo)){
                        ...
                        //valido si la cantidad es mayor que el stocj
                        if(me.cantidad<me.stock){
                             //agrego al array con el push
                            ...
                            alert('No contamos con esa cantidad de producto');
                        }
                    }
                }
            },
            ...
            //metodo que permite el filtro por codigo 
            listarArticulos(criterio, buscar){
                let atrapar = this;
                //recibo el page dentro de la url de controller
                var url = '/articulo/listadoVenta?buscar=' + buscar + '&criterio=' + criterio;
                //capturo en la peticion la url
                axios.get(url).then(function (json) {
        ...
        mounted() {
            this.listarVenta(1, this.criterio, this.buscar);
            this.selectCliente();
        }
    }
